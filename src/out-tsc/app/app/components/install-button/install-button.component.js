...
let InstallButtonComponent = (() => {
    ...
    let _classThis;
    var InstallButtonComponent = class {
        ...
        static {
            ...
            InstallButtonComponent = _classThis = _classDescriptor.value;
    ...
    return InstallButtonComponent = _classThis;
})();
export { InstallButtonComponent };
